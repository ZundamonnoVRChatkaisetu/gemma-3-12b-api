...
### 7.1 UIコンポーネントのTypeScript/JSX対応修正 (2025-03-15)
...
### 7.6 コードブロック検出と強化表示機能の追加 (2025-03-15)
...
### 7.10 EnhancedFileManagerコンポーネントの分割 (2025-03-14)
...
### 7.24 APIベースURL設定の改善 (2025-03-15)
...
### 7.35 TypeScript/JSXファイル拡張子の修正 (2025-03-15)
- JSX構文を含むファイルの拡張子を `.ts` から `.tsx` に変更
- 特に `use-toast.tsx` の修正によりビルドエラーを解消
- リファレンスエラーを防ぐために古いファイルからエクスポートを追加
- Next.js 14のクライアントコンポーネント構造に準拠
